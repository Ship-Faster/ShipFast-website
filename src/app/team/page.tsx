...
const team = [
  ...
  },
  {
    ...
    subtitle: "Frontend & Backend",
    avatar: "LK",
    bio: "Full Stack Developer focused on system design and scalable applications. I build clean backend systems, efficient APIs, and maintainable solutions.",
    skills: ["Java", "SpringBoot", "React", "Angular", "NestJS", "TypeScript", "SQL", "PostgresSQL"],
    icon: Code2,
